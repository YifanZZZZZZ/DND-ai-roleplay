...
class SummaryService:
    """Builds editable, privacy-filtered Campaign records without hidden model state."""

    def __init__(self, session: AsyncSession) -> None:
        self.session = session

    async def build_for_campaign(self, game_session: GameSession) -> None:
        members = list(
    ...
    async def build_for_session(self, game_session: GameSession) -> None:
        ...
        await self.build_for_campaign(game_session)
